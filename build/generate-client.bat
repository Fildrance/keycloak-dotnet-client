curl https://repo1.maven.org/maven2/io/swagger/codegen/v3/swagger-codegen-cli/3.0.54/swagger-codegen-cli-3.0.54.jar -o swagger-codegen-cli.jar
curl https://raw.githubusercontent.com/ccouzens/keycloak-openapi/main/keycloak/23.0.7.json -o contracts.json

java -jar swagger-codegen-cli.jar generate -i contracts.json -l csharp-dotnet2 -o .\..\src\Keycloak.Client\
