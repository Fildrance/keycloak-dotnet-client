...
java -jar swagger-codegen-cli.jar generate -i contracts.json -l csharp-dotnet-core -o .\..\src\Keycloak.Client\ --template-engine mustache --additional-properties packageName=Keycloak.Client clientPackage=Keycloak.Client
