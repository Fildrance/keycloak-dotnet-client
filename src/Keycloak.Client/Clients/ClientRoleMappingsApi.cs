...
/// </summary>  
[GeneratedCode("swagger-codegen", "3.0.56-SNAPSHOT")]
public partial class ClientRoleMappingsApi : IOSwaggerClientApiClientBase, IClientRoleMappingsApi
{
    /// <summary>
    ...
    public async Task DeleteGroupRoleMappingsClient(string realm, string id, string _client, RoleRepresentation body, CancellationToken ct)
    {
        ...
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling DeleteGroupRoleMappingsClient");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling DeleteGroupRoleMappingsClient");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling DeleteGroupRoleMappingsClient");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task DeleteUserRoleMappingsClient(string realm, string id, string _client, RoleRepresentation body, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling DeleteUserRoleMappingsClient");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling DeleteUserRoleMappingsClient");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling DeleteUserRoleMappingsClient");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task<List<RoleRepresentation>> GetGroupRoleMappingsClient(string realm, string id, string _client, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetGroupRoleMappingsClient");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetGroupRoleMappingsClient");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling GetGroupRoleMappingsClient");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task<List<RoleRepresentation>> GetGroupRoleMappingsClientAvailable(string realm, string id, string _client, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetGroupRoleMappingsClientAvailable");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetGroupRoleMappingsClientAvailable");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling GetGroupRoleMappingsClientAvailable");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task<List<RoleRepresentation>> GetGroupRoleMappingsClientComposite(string realm, string id, string _client, string briefRepresentation, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetGroupRoleMappingsClientComposite");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetGroupRoleMappingsClientComposite");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling GetGroupRoleMappingsClientComposite");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task<List<RoleRepresentation>> GetUserRoleMappingsClient(string realm, string id, string _client, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetUserRoleMappingsClient");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetUserRoleMappingsClient");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling GetUserRoleMappingsClient");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task<List<RoleRepresentation>> GetUserRoleMappingsClientAvailable(string realm, string id, string _client, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetUserRoleMappingsClientAvailable");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetUserRoleMappingsClientAvailable");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling GetUserRoleMappingsClientAvailable");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task<List<RoleRepresentation>> GetUserRoleMappingsClientComposite(string realm, string id, string _client, string briefRepresentation, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetUserRoleMappingsClientComposite");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetUserRoleMappingsClientComposite");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling GetUserRoleMappingsClientComposite");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task PostGroupRoleMappingsClient(string realm, string id, string _client, RoleRepresentation body, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PostGroupRoleMappingsClient");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PostGroupRoleMappingsClient");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling PostGroupRoleMappingsClient");
...
path_ = path_.Replace("{client}", ParameterToString(_client));
    ...
    public async Task PostUserRoleMappingsClient(string realm, string id, string _client, RoleRepresentation body, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PostUserRoleMappingsClient");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PostUserRoleMappingsClient");
        
        // verify the required parameter '_client' is set
        if (_client == null) throw new IOSwaggerClientApiException(400, "Missing required parameter '_client' when calling PostUserRoleMappingsClient");
