...
/// </summary>  
[GeneratedCode("swagger-codegen", "3.0.56-SNAPSHOT")]
public partial class ClientsApi : IOSwaggerClientApiClientBase, IClientsApi
{
    /// <summary>
    ...
    public async Task DeleteClientByRealmById(string realm, string id, CancellationToken ct)
    {
        ...
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling DeleteClientByRealmById");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling DeleteClientByRealmById");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task DeleteDefaultClientScope(string realm, string id, string clientScopeId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling DeleteDefaultClientScope");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling DeleteDefaultClientScope");
        
        // verify the required parameter 'clientScopeId' is set
        if (clientScopeId == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'clientScopeId' when calling DeleteDefaultClientScope");
...
path_ = path_.Replace("{clientScopeId}", ParameterToString(clientScopeId));
    ...
    public async Task DeleteNode(string realm, string id, string node, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling DeleteNode");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling DeleteNode");
        
        // verify the required parameter 'node' is set
        if (node == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'node' when calling DeleteNode");
...
path_ = path_.Replace("{node}", ParameterToString(node));
    ...
    public async Task DeleteOptionalClientScope(string realm, string id, string clientScopeId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling DeleteOptionalClientScope");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling DeleteOptionalClientScope");
        
        // verify the required parameter 'clientScopeId' is set
        if (clientScopeId == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'clientScopeId' when calling DeleteOptionalClientScope");
...
path_ = path_.Replace("{clientScopeId}", ParameterToString(clientScopeId));
    ...
    public async Task DeleteRotated(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling DeleteRotated");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling DeleteRotated");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<ClientRepresentation> GetClientByRealmById(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetClientByRealmById");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetClientByRealmById");
...
path_ = path_.Replace("{id}", ParameterToString(id));
        ...
        var response = await CallApi<ClientRepresentation>(path_.ToString(), HttpMethod.Get, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task<ManagementPermissionReference> GetClientManagementPermissions(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetClientManagementPermissions");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetClientManagementPermissions");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<CredentialRepresentation> GetClientSecret(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetClientSecret");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetClientSecret");
...
path_ = path_.Replace("{id}", ParameterToString(id));
        ...
        var response = await CallApi<CredentialRepresentation>(path_.ToString(), HttpMethod.Get, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task<List<UserSessionRepresentation>> GetClientUserSessions(string realm, string id, string first, string max, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetClientUserSessions");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetClientUserSessions");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<List<ClientRepresentation>> GetClients(string realm, string clientId, string first, string max, string q, string search, string viewableOnly, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetClients");
        ...
        var response = await CallApi<List<ClientRepresentation>>(path_.ToString(), HttpMethod.Get, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task<List<ClientScopeRepresentation>> GetDefaultClientScopes(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetDefaultClientScopes");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetDefaultClientScopes");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<AccessToken> GetGenerateExampleAccessToken(string realm, string id, string scope, string userId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetGenerateExampleAccessToken");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetGenerateExampleAccessToken");
...
path_ = path_.Replace("{id}", ParameterToString(id));
        ...
        var response = await CallApi<AccessToken>(path_.ToString(), HttpMethod.Get, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task<IDToken> GetGenerateExampleIdToken(string realm, string id, string scope, string userId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetGenerateExampleIdToken");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetGenerateExampleIdToken");
...
path_ = path_.Replace("{id}", ParameterToString(id));
        ...
        var response = await CallApi<IDToken>(path_.ToString(), HttpMethod.Get, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task<Dictionary<string, Object>> GetGenerateExampleUserinfo(string realm, string id, string scope, string userId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetGenerateExampleUserinfo");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetGenerateExampleUserinfo");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<List<RoleRepresentation>> GetGranted(string realm, string id, string roleContainerId, string scope, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetGranted");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetGranted");
        
        // verify the required parameter 'roleContainerId' is set
        if (roleContainerId == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'roleContainerId' when calling GetGranted");
...
path_ = path_.Replace("{roleContainerId}", ParameterToString(roleContainerId));
    ...
    public async Task GetInstallationProvider(string realm, string id, string providerId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetInstallationProvider");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetInstallationProvider");
        
        // verify the required parameter 'providerId' is set
        if (providerId == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'providerId' when calling GetInstallationProvider");
...
path_ = path_.Replace("{providerId}", ParameterToString(providerId));
    ...
    public async Task<List<RoleRepresentation>> GetNotGranted(string realm, string id, string roleContainerId, string scope, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetNotGranted");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetNotGranted");
        
        // verify the required parameter 'roleContainerId' is set
        if (roleContainerId == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'roleContainerId' when calling GetNotGranted");
...
path_ = path_.Replace("{roleContainerId}", ParameterToString(roleContainerId));
    ...
    public async Task<Dictionary<string, long?>> GetOfflineSessionCount(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetOfflineSessionCount");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetOfflineSessionCount");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<List<UserSessionRepresentation>> GetOfflineSessions(string realm, string id, string first, string max, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetOfflineSessions");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetOfflineSessions");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<List<ClientScopeRepresentation>> GetOptionalClientScopes(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetOptionalClientScopes");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetOptionalClientScopes");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<List<ProtocolMapperEvaluationRepresentation>> GetProtocolMappers(string realm, string id, string scope, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetProtocolMappers");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetProtocolMappers");
...
path_ = path_.Replace("{id}", ParameterToString(id));
        ...
        var response = await CallApi<List<ProtocolMapperEvaluationRepresentation>>(path_.ToString(), HttpMethod.Get, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task<CredentialRepresentation> GetRotated(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetRotated");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetRotated");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<UserRepresentation> GetServiceAccountUser(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetServiceAccountUser");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetServiceAccountUser");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<Dictionary<string, long?>> GetSessionCount(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetSessionCount");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetSessionCount");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<GlobalRequestResult> GetTestNodesAvailable(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling GetTestNodesAvailable");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling GetTestNodesAvailable");
...
path_ = path_.Replace("{id}", ParameterToString(id));
        ...
        var response = await CallApi<GlobalRequestResult>(path_.ToString(), HttpMethod.Get, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task<GlobalRequestResult> PostClientPushRevocation(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PostClientPushRevocation");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PostClientPushRevocation");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<CredentialRepresentation> PostClientSecret(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PostClientSecret");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PostClientSecret");
...
path_ = path_.Replace("{id}", ParameterToString(id));
        ...
        var response = await CallApi<CredentialRepresentation>(path_.ToString(), HttpMethod.Post, queryParams, postBody, headerParams, formParams, fileParams, ct);
    ...
    public async Task PostClients(string realm, ClientRepresentation body, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PostClients");
    ...
    public async Task PostNodes(string realm, string id, string body, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PostNodes");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PostNodes");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<ClientRepresentation> PostRegistrationAccessToken(string realm, string id, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PostRegistrationAccessToken");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PostRegistrationAccessToken");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task PutClient(string realm, string id, ClientRepresentation body, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PutClient");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PutClient");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task<ManagementPermissionReference> PutClientManagementPermissions(string realm, string id, ManagementPermissionReference body, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PutClientManagementPermissions");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PutClientManagementPermissions");
...
path_ = path_.Replace("{id}", ParameterToString(id));
    ...
    public async Task PutDefaultClientScope(string realm, string id, string clientScopeId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PutDefaultClientScope");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PutDefaultClientScope");
        
        // verify the required parameter 'clientScopeId' is set
        if (clientScopeId == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'clientScopeId' when calling PutDefaultClientScope");
...
path_ = path_.Replace("{clientScopeId}", ParameterToString(clientScopeId));
    ...
    public async Task PutOptionalClientScope(string realm, string id, string clientScopeId, CancellationToken ct)
    {
        ...
        // verify the required parameter 'realm' is set
        if (realm == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'realm' when calling PutOptionalClientScope");
        
        // verify the required parameter 'id' is set
        if (id == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'id' when calling PutOptionalClientScope");
        
        // verify the required parameter 'clientScopeId' is set
        if (clientScopeId == null) throw new IOSwaggerClientApiException(400, "Missing required parameter 'clientScopeId' when calling PutOptionalClientScope");
