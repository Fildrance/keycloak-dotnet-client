...
namespace IO.Swagger.Model {
  ...
  public class AccessToken {
    ...
    /// </summary>
    [DataMember(Name="authTime", EmitDefaultValue=false)]
    ...
    /// </summary>
    [DataMember(Name="resource_access", EmitDefaultValue=false)]
    ...
    public override string ToString()  {
      ...
      sb.Append("  ResourceAccess: ").Append(ResourceAccess).Append("\n");
