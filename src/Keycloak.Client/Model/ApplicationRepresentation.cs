...
namespace IO.Swagger.Model {
  ...
  public class ApplicationRepresentation {
    ...
    [JsonProperty(PropertyName = "alwaysDisplayInConsole")]
    ...
    [JsonProperty(PropertyName = "oauth2DeviceAuthorizationGrantEnabled")]
    ...
    /// </summary>
    [DataMember(Name="directGrantsOnly", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "directGrantsOnly")]
    ...
    /// </summary>
    [DataMember(Name="useTemplateConfig", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "useTemplateConfig")]
    public bool? UseTemplateConfig { get; set; }

    /// <summary>
    /// Gets or Sets UseTemplateScope
    /// </summary>
    [DataMember(Name="useTemplateScope", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "useTemplateScope")]
    public bool? UseTemplateScope { get; set; }

    /// <summary>
    /// Gets or Sets UseTemplateMappers
    /// </summary>
    [DataMember(Name="useTemplateMappers", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "useTemplateMappers")]
