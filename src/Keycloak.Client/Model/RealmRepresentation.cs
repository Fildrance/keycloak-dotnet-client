...
namespace IO.Swagger.Model {
  ...
  public class RealmRepresentation {
    ...
    [JsonProperty(PropertyName = "clientSessionIdleTimeout")]
    ...
    [JsonProperty(PropertyName = "clientSessionMaxLifespan")]
    ...
    [JsonProperty(PropertyName = "clientOfflineSessionIdleTimeout")]
    ...
    [JsonProperty(PropertyName = "clientOfflineSessionMaxLifespan")]
    ...
    [JsonProperty(PropertyName = "oauth2DeviceCodeLifespan")]
    ...
    [JsonProperty(PropertyName = "oauth2DevicePollingInterval")]
    ...
    /// </summary>
    [DataMember(Name="passwordCredentialGrantAllowed", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "passwordCredentialGrantAllowed")]
    ...
    /// </summary>
    [DataMember(Name="userCacheEnabled", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "userCacheEnabled")]
    public bool? UserCacheEnabled { get; set; }

    /// <summary>
    /// Gets or Sets RealmCacheEnabled
    /// </summary>
    [DataMember(Name="realmCacheEnabled", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "realmCacheEnabled")]
    ...
    /// </summary>
    [DataMember(Name="codeSecret", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "codeSecret")]
    ...
    /// </summary>
    [DataMember(Name="requiredCredentials", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "requiredCredentials")]
    ...
    /// </summary>
    [DataMember(Name="otpPolicyCodeReusable", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "otpPolicyCodeReusable")]
    ...
    /// </summary>
    [DataMember(Name="localizationTexts", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "localizationTexts")]
    ...
    /// </summary>
    [DataMember(Name="webAuthnPolicyExtraOrigins", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "webAuthnPolicyExtraOrigins")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessRpEntityName")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessSignatureAlgorithms")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessRpId")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessAttestationConveyancePreference")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessAuthenticatorAttachment")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessRequireResidentKey")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessUserVerificationRequirement")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessCreateTimeout")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessAvoidSameAuthenticatorRegister")]
    ...
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessAcceptableAaguids")]
    ...
    /// </summary>
    [DataMember(Name="webAuthnPolicyPasswordlessExtraOrigins", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "webAuthnPolicyPasswordlessExtraOrigins")]
    ...
    [JsonProperty(PropertyName = "clientProfiles")]
    ...
    [JsonProperty(PropertyName = "clientPolicies")]
    ...
    /// </summary>
    [DataMember(Name="updateProfileOnInitialSocialLogin", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "updateProfileOnInitialSocialLogin")]
    ...
    /// </summary>
    [DataMember(Name="applicationScopeMappings", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "applicationScopeMappings")]
    ...
    /// </summary>
    [DataMember(Name="clientTemplates", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "clientTemplates")]
